!function (t) {
    ...
    o.prototype = new n.L2DBaseModel, o.prototype.load = function (t, i, e) {
        ...
        return "head" == t ? this.hitTestSimpleCustom(h.default.HIT_AREA_HEAD, h.default.HIT_AREA_HEAD, i, e) : "body" == t && this.hitTestSimpleCustom(h.default.hit_areas_custom_body_x, h.default.hit_areas_custom_body_y, i, e)
    }
}, function (t, i, e) {
    "use strict";
